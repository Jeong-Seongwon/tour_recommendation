"""
Django settings for tour_recommendation project.
...
SECRET_KEY = 'django-insecure-1#2!%hukfcny@45iumxfx6i6_9lgd2e6#!0^94gl49$xx++qam'
...
WSGI_APPLICATION = 'tour_recommendation.wsgi.application'
...
DATABASES = {
    'default': {
      'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'tour_recommendation',       # 생성한 데이터베이스 이름
        'USER': 'postgres',          # 생성한 사용자 이름
        'PASSWORD': 'sejong',  # 생성한 비밀번호
